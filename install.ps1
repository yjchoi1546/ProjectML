...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.01.23-916f423-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2026.01.23-916f423/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.01.23-916f423"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2026.01.23-916f423/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.01.23-916f423/cursor-agent ~/.local/bin/cursor-agent
